...
class SearchScreenState extends State<SearchScreen> {
  ...
  void _searchMovies() async {
    ...
    try {
      final List<Map<String, dynamic>> searchData = await _apiService.searchMovies(query);
      
      print("API Response: $searchData"); // Debugging

      setState(() {
        _searchResults = searchData.map((e) => Movie.fromJson(e)).toList();
      });

      print("Updated search results: $_searchResults"); // Debugging
